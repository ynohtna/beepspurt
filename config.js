System.config({
  ...
  map: {
    ...
    "plask": "@empty",
    "react": "client/shim_react.js",
    "react-dom": "client/shim_react-dom.js",
    ...
    "short-uuid": "npm:short-uuid@2.1.0",
    "spdy": "npm:spdy@3.2.3",
    ...
    "github:ynohtna/node-restify@hacks": {
      ...
      "buffer": "github:jspm/nodelibs-buffer@0.1.0",
      "bunyan": "npm:bunyan@1.8.0",
      "csv": "npm:csv@0.4.6",
      "domain": "github:jspm/nodelibs-domain@0.1.0",
      "escape-regexp-component": "npm:escape-regexp-component@1.0.2",
      "events": "github:jspm/nodelibs-events@0.1.1",
      ...
      "process": "github:jspm/nodelibs-process@0.1.2",
      "qs": "npm:qs@5.2.0",
      "restify-errors": "npm:restify-errors@3.1.0",
      "semver": "npm:semver@5.1.0",
      "spdy": "npm:spdy@3.2.3",
      "stream": "github:jspm/nodelibs-stream@0.1.0",
      "url": "github:jspm/nodelibs-url@0.1.0",
      "util": "github:jspm/nodelibs-util@0.1.0",
      "vasync": "npm:vasync@1.6.4"
    },
    "npm:acorn@1.2.2": {
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "path": "github:jspm/nodelibs-path@0.1.0",
    ...
    "npm:bunyan@1.8.0": {
      "assert": "github:jspm/nodelibs-assert@0.1.0",
      "buffer": "github:jspm/nodelibs-buffer@0.1.0",
      "dtrace-provider": "npm:dtrace-provider@0.6.0",
      "events": "github:jspm/nodelibs-events@0.1.1",
      "fs": "github:jspm/nodelibs-fs@0.1.2",
    ...
    "npm:restify-errors@3.1.0": {
      "assert-plus": "npm:assert-plus@0.2.0",
      "http": "github:jspm/nodelibs-http@1.7.1",
      "lodash": "npm:lodash@3.10.1",
      "util": "github:jspm/nodelibs-util@0.1.0",
      "verror": "npm:verror@1.6.0"
    },
    "npm:restify-plugins@1.0.2": {
      "assert-plus": "npm:assert-plus@0.2.0",
      "buffer": "github:jspm/nodelibs-buffer@0.1.0",
      "bunyan": "npm:bunyan@1.8.0",
      "crypto": "github:jspm/nodelibs-crypto@0.1.0",
    ...
    "npm:short-uuid@2.1.0": {
      "any-base": "npm:any-base@1.0.0",
      "node-uuid": "npm:node-uuid@1.4.7"
    },
    "npm:source-map@0.5.3": {
      "process": "github:jspm/nodelibs-process@0.1.2"
    },
    "npm:spdy-transport@2.0.10": {
      "assert": "github:jspm/nodelibs-assert@0.1.0",
      "buffer": "github:jspm/nodelibs-buffer@0.1.0",
      "debug": "npm:debug@2.2.0",
      "events": "github:jspm/nodelibs-events@0.1.1",
      "hpack.js": "npm:hpack.js@2.1.4",
      "obuf": "npm:obuf@1.1.1",
      "process": "github:jspm/nodelibs-process@0.1.2",
      "readable-stream": "npm:readable-stream@2.1.0",
      "util": "github:jspm/nodelibs-util@0.1.0",
    ...
    "npm:spdy@3.2.3": {
      ...
      "events": "github:jspm/nodelibs-events@0.1.1",
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "handle-thing": "npm:handle-thing@1.2.4",
      "http": "github:jspm/nodelibs-http@1.7.1",
      "http-deceiver": "npm:http-deceiver@1.2.4",
      "https": "github:jspm/nodelibs-https@0.1.0",
      "net": "github:jspm/nodelibs-net@0.1.2",
      "process": "github:jspm/nodelibs-process@0.1.2",
      "select-hose": "npm:select-hose@2.0.0",
      "spdy-transport": "npm:spdy-transport@2.0.10",
    ...
    "npm:verror@1.6.0": {
      "assert": "github:jspm/nodelibs-assert@0.1.0",
      "extsprintf": "npm:extsprintf@1.2.0",
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "process": "github:jspm/nodelibs-process@0.1.2",
      "util": "github:jspm/nodelibs-util@0.1.0"
    },
    ...
    "npm:watershed@0.3.1": {
      ...
      "events": "github:jspm/nodelibs-events@0.1.1",
      "process": "github:jspm/nodelibs-process@0.1.2",
      "readable-stream": "npm:readable-stream@1.0.2",
      "stream": "github:jspm/nodelibs-stream@0.1.0",
      "util": "github:jspm/nodelibs-util@0.1.0"
    },
    "npm:wbuf@1.7.1": {
